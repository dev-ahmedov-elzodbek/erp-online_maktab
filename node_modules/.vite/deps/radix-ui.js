import {
  ...
  useId,
  useLayoutEffect2
} from "./chunk-IOFLBDSX.js";
import {
  require_react_dom
} from "./chunk-SJSIPKFV.js";
import {
  require_jsx_runtime
...
function createCollection(name) {
  const PROVIDER_NAME4 = name + "CollectionProvider";
  const [createCollectionContext, createCollectionScope10] = createContextScope(PROVIDER_NAME4);
...
function createCollection2(name) {
  ...
  CollectionInit.displayName = PROVIDER_NAME4 + "Init";
  ...
  CollectionProviderImpl.displayName = PROVIDER_NAME4 + "Impl";
  const COLLECTION_SLOT_NAME = name + "CollectionSlot";
  const CollectionSlotImpl = createSlot(COLLECTION_SLOT_NAME);
...
var AccordionImplSingle = React6.forwardRef(
  (props, forwardedRef) => {
    const {
      value: valueProp,
      defaultValue,
    ...
    return (0, import_jsx_runtime7.jsx)(
      AccordionValueProvider,
      {
        ...
        value: React6.useMemo(() => value ? [value] : [], [value]),
        onItemOpen: setValue,
        onItemClose: React6.useCallback(() => collapsible && setValue(""), [collapsible, setValue]),
...
var AccordionImplMultiple = React6.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {
  ...
  const handleItemOpen = React6.useCallback(
    (itemValue) => setValue((prevValue = []) => [...prevValue, itemValue]),
    [setValue]
  );
  const handleItemClose = React6.useCallback(
...
var AccordionImpl = React6.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAccordion, disabled, dir, orientation = "vertical", ...accordionProps } = props;
    const accordionRef = React6.useRef(null);
...
function useIsHydrated() {
  const [isHydrated, setIsHydrated] = React9.useState(_isHydrated);
  React9.useEffect(() => {
    if (!_isHydrated) {
      _isHydrated = true;
      setIsHydrated(true);
...
var useReactSyncExternalStore = React23[" useSyncExternalStore ".trim().toString()];
function subscribe() {
  return () => {
  };
}
...
var Avatar = React10.forwardRef(
  (props, forwardedRef) => {
    ...
    const [imageLoadingStatus, setImageLoadingStatus] = React10.useState("idle");
...
var AvatarImage = React10.forwardRef(
  (props, forwardedRef) => {
...
var AvatarFallback = React10.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAvatar, delayMs, ...fallbackProps } = props;
    const context = useAvatarContext(FALLBACK_NAME, __scopeAvatar);
    const [canRender, setCanRender] = React10.useState(delayMs === void 0);
    React10.useEffect(() => {
      if (delayMs !== void 0) {
...
function useImageLoadingStatus(src, { referrerPolicy, crossOrigin }) {
  ...
  const [loadingStatus, setLoadingStatus] = React10.useState(
...
var PopperAnchor = React16.forwardRef(
  (props, forwardedRef) => {
    ...
    const callbackRef = React16.useCallback(
      (node) => {
        ref.current = node;
        if (node) {
          onAnchorChange(node);
    ...
    return virtualRef ? null : (0, import_jsx_runtime13.jsx)(
      Primitive.div,
      {
...
var PopperContent = React16.forwardRef(
  (props, forwardedRef) => {
    ...
    const detectOverflowOptions = {
      ...
      boundary: boundary == null ? void 0 : boundary.filter(isNotNull),
...
var RovingFocusGroup = React17.forwardRef(
  (props, forwardedRef) => {
    return (0, import_jsx_runtime14.jsx)(Collection2.Provider, { scope: props.__scopeRovingFocusGroup, children: (0, import_jsx_runtime14.jsx)(Collection2.Slot, { scope: props.__scopeRovingFocusGroup, children: (0, import_jsx_runtime14.jsx)(RovingFocusGroupImpl, { ...props, ref: forwardedRef }) }) });
  }
);
...
var RovingFocusGroupItem = React17.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
...
var Menu = (props) => {
  ...
  return (0, import_jsx_runtime15.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime15.jsx)(
    MenuProvider,
    {
      scope: __scopeMenu,
      open,
...
var MenuContent = React18.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext(CONTENT_NAME5, props.__scopeMenu);
...
var MenuRootContentNonModal = React18.forwardRef((props, forwardedRef) => {
  const context = useMenuContext(CONTENT_NAME5, props.__scopeMenu);
  return (0, import_jsx_runtime15.jsx)(
    MenuContentImpl,
    {
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime15.jsx)(
      Collection3.ItemSlot,
      {
        ...
        children: (0, import_jsx_runtime15.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: !disabled, children: (0, import_jsx_runtime15.jsx)(
          Primitive.div,
          {
            role: "menuitem",
...
var MenuSubContent = React18.forwardRef(
  (props, forwardedRef) => {
    ...
    const ref = React18.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, ref);
    return (0, import_jsx_runtime15.jsx)(Collection3.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime15.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime15.jsx)(Collection3.Slot, { scope: props.__scopeMenu, children: (0, import_jsx_runtime15.jsx)(
      MenuContentImpl,
      {
...
var ContextMenu = (props) => {
  ...
  const hasInteractedRef = React19.useRef(false);
  if (true) {
    const hasWarnedRef = React19.useRef(false);
    React19.useEffect(() => {
  ...
  return (0, import_jsx_runtime16.jsx)(
    ContextMenuProvider,
    {
      ...
      modal,
      hasInteractedRef,
      children: (0, import_jsx_runtime16.jsx)(Root32, { ...menuScope, dir, open, onOpenChange: setOpen, modal, children })
    }
  );
};
ContextMenu.displayName = CONTEXT_MENU_NAME;
var TRIGGER_NAME5 = "ContextMenuTrigger";
var ContextMenuTrigger = React19.forwardRef(
  (props, forwardedRef) => {
    const { __scopeContextMenu, disabled = false, ...triggerProps } = props;
    const context = useContextMenuContext(TRIGGER_NAME5, __scopeContextMenu);
    const menuScope = useMenuScope(__scopeContextMenu);
    const pointRef = React19.useRef({ x: 0, y: 0 });
    const virtualRef = React19.useRef({
      getBoundingClientRect: () => DOMRect.fromRect({ width: 0, height: 0, ...pointRef.current })
    });
    const longPressTimerRef = React19.useRef(0);
    const clearLongPress = React19.useCallback(
    ...
    React19.useEffect(() => clearLongPress, [clearLongPress]);
    React19.useEffect(() => void (disabled && clearLongPress()), [disabled, clearLongPress]);
    return (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
      (0, import_jsx_runtime16.jsx)(Anchor2, { ...menuScope, virtualRef }),
...
var ContextMenuPortal = (props) => {
  ...
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime16.jsx)(Portal3, { ...menuScope, ...portalProps });
};
ContextMenuPortal.displayName = PORTAL_NAME3;
var CONTENT_NAME6 = "ContextMenuContent";
var ContextMenuContent = React19.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuGroup = React19.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuLabel = React19.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuItem = React19.forwardRef(
  (props, forwardedRef) => {
    const { __scopeContextMenu, ...itemProps } = props;
    const menuScope = useMenuScope(__scopeContextMenu);
    return (0, import_jsx_runtime16.jsx)(Item22, { ...menuScope, ...itemProps, ref: forwardedRef });
  }
);
ContextMenuItem.displayName = ITEM_NAME4;
var CHECKBOX_ITEM_NAME2 = "ContextMenuCheckboxItem";
var ContextMenuCheckboxItem = React19.forwardRef((props, forwardedRef) => {
...
var ContextMenuRadioGroup = React19.forwardRef((props, forwardedRef) => {
...
var ContextMenuRadioItem = React19.forwardRef((props, forwardedRef) => {
...
var ContextMenuItemIndicator = React19.forwardRef((props, forwardedRef) => {
...
var ContextMenuSeparator = React19.forwardRef((props, forwardedRef) => {
...
var ContextMenuArrow = React19.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuSubTrigger = React19.forwardRef((props, forwardedRef) => {
  const { __scopeContextMenu, ...triggerItemProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime16.jsx)(SubTrigger, { ...menuScope, ...triggerItemProps, ref: forwardedRef });
});
ContextMenuSubTrigger.displayName = SUB_TRIGGER_NAME2;
var SUB_CONTENT_NAME2 = "ContextMenuSubContent";
var ContextMenuSubContent = React19.forwardRef((props, forwardedRef) => {
...
var DropdownMenuTrigger = React20.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuContent = React20.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuGroup = React20.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuLabel = React20.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuItem = React20.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuCheckboxItem = React20.forwardRef((props, forwardedRef) => {
...
var DropdownMenuRadioGroup = React20.forwardRef((props, forwardedRef) => {
...
var DropdownMenuRadioItem = React20.forwardRef((props, forwardedRef) => {
...
var DropdownMenuItemIndicator = React20.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSeparator = React20.forwardRef((props, forwardedRef) => {
...
var DropdownMenuArrow = React20.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuSubTrigger = React20.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSubContent = React20.forwardRef((props, forwardedRef) => {
...
var NAME5 = "Label";
var Label3 = React21.forwardRef((props, forwardedRef) => {
...
var Form = React24.forwardRef(
  (props, forwardedRef) => {
    const { __scopeForm, onClearServerErrors = () => {
    }, ...rootProps } = props;
    const formRef = React24.useRef(null);
    const composedFormRef = useComposedRefs(forwardedRef, formRef);
    const [validityMap, setValidityMap] = React24.useState({});
    const getFieldValidity = React24.useCallback(
      (fieldName) => validityMap[fieldName],
      [validityMap]
    );
    const handleFieldValidityChange = React24.useCallback(
    ...
    const handleFieldValiditionClear = React24.useCallback((fieldName) => {
      setValidityMap((prevValidityMap) => ({ ...prevValidityMap, [fieldName]: void 0 }));
      setCustomErrorsMap((prevCustomErrorsMap) => ({ ...prevCustomErrorsMap, [fieldName]: {} }));
    }, []);
    const [customMatcherEntriesMap, setCustomMatcherEntriesMap] = React24.useState({});
    const getFieldCustomMatcherEntries = React24.useCallback(
      (fieldName) => customMatcherEntriesMap[fieldName] ?? [],
      [customMatcherEntriesMap]
    );
    const handleFieldCustomMatcherAdd = React24.useCallback((fieldName, matcherEntry) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
        [fieldName]: [...prevCustomMatcherEntriesMap[fieldName] ?? [], matcherEntry]
      }));
    }, []);
    const handleFieldCustomMatcherRemove = React24.useCallback((fieldName, matcherEntryId) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
    ...
    const [customErrorsMap, setCustomErrorsMap] = React24.useState({});
    const getFieldCustomErrors = React24.useCallback(
      (fieldName) => customErrorsMap[fieldName] ?? {},
      [customErrorsMap]
    );
    const handleFieldCustomErrorsChange = React24.useCallback((fieldName, customErrors) => {
      setCustomErrorsMap((prevCustomErrorsMap) => ({
        ...prevCustomErrorsMap,
        [fieldName]: { ...prevCustomErrorsMap[fieldName] ?? {}, ...customErrors }
      }));
    }, []);
    const [messageIdsMap, setMessageIdsMap] = React24.useState({});
    const handleFieldMessageIdAdd = React24.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
        const fieldDescriptionIds = new Set(prevMessageIdsMap[fieldName]).add(id);
        return { ...prevMessageIdsMap, [fieldName]: fieldDescriptionIds };
      });
    }, []);
    const handleFieldMessageIdRemove = React24.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
    ...
    const getFieldDescription = React24.useCallback(
...
var FormField = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    const id = useId();
    return (0, import_jsx_runtime19.jsx)(FormFieldProvider, { scope: __scopeForm, id, name, serverInvalid, children: (0, import_jsx_runtime19.jsx)(
      Primitive.div,
      {
...
var FormControl = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    const updateControlValidity = React24.useCallback(
      async (control) => {
    ...
    const resetControlValidity = React24.useCallback(() => {
      const control = ref.current;
      if (control) {
...
var FormMessage = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    if (match === void 0) {
      return (0, import_jsx_runtime19.jsx)(FormMessageImpl, { ...messageProps, ref: forwardedRef, name, children: props.children || DEFAULT_INVALID_MESSAGE });
    } else if (typeof match === "function") {
      return (0, import_jsx_runtime19.jsx)(FormCustomMessage, { match, ...messageProps, ref: forwardedRef, name });
    } else {
      return (0, import_jsx_runtime19.jsx)(FormBuiltInMessage, { match, ...messageProps, ref: forwardedRef, name });
    }
  }
);
FormMessage.displayName = MESSAGE_NAME;
var FormBuiltInMessage = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    if (matches) {
      return (0, import_jsx_runtime19.jsx)(FormMessageImpl, { ref: forwardedRef, ...messageProps, name, children: children ?? DEFAULT_BUILT_IN_MESSAGES[match] });
    }
    return null;
  }
);
var FormCustomMessage = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    const _id = useId();
    const id = idProp ?? _id;
    const customMatcherEntry = React24.useMemo(() => ({ id, match }), [id, match]);
    ...
    if (matches) {
      return (0, import_jsx_runtime19.jsx)(FormMessageImpl, { id, ref: composedRef, ...messageProps, name, children: children ?? DEFAULT_INVALID_MESSAGE });
    }
    return null;
  }
);
var FormMessageImpl = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime19.jsx)(Primitive.span, { id, ...messageProps, ref: forwardedRef });
  }
);
...
var FormValidityState = (props) => {
  ...
  const name = nameProp ?? fieldContext.name;
  const validity = validationContext.getFieldValidity(name);
  return (0, import_jsx_runtime19.jsx)(import_jsx_runtime19.Fragment, { children: children(validity) });
};
FormValidityState.displayName = VALIDITY_STATE_NAME;
var SUBMIT_NAME = "FormSubmit";
var FormSubmit = React24.forwardRef(
  (props, forwardedRef) => {
    const { __scopeForm, ...submitProps } = props;
    return (0, import_jsx_runtime19.jsx)(Primitive.button, { type: "submit", ...submitProps, ref: forwardedRef });
  }
);
...
var HoverCard = (props) => {
  ...
  const hasSelectionRef = React25.useRef(false);
  const isPointerDownOnContentRef = React25.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: onOpenChange,
  ...
  const handleDismiss = React25.useCallback(() => setOpen(false), [setOpen]);
  React25.useEffect(() => {
    return () => {
      clearTimeout(openTimerRef.current);
      clearTimeout(closeTimerRef.current);
  ...
  return (0, import_jsx_runtime20.jsx)(
    HoverCardProvider,
    {
      ...
      children: (0, import_jsx_runtime20.jsx)(Root25, { ...popperScope, children })
    }
  );
};
HoverCard.displayName = HOVERCARD_NAME;
var TRIGGER_NAME7 = "HoverCardTrigger";
var HoverCardTrigger = React25.forwardRef(
  (props, forwardedRef) => {
...
var HoverCardPortal = (props) => {
  ...
  return (0, import_jsx_runtime20.jsx)(PortalProvider2, { scope: __scopeHoverCard, forceMount, children: (0, import_jsx_runtime20.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime20.jsx)(Portal, { asChild: true, container, children }) }) });
};
HoverCardPortal.displayName = PORTAL_NAME5;
var CONTENT_NAME8 = "HoverCardContent";
var HoverCardContent = React25.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext2(CONTENT_NAME8, props.__scopeHoverCard);
    const { forceMount = portalContext.forceMount, ...contentProps } = props;
    const context = useHoverCardContext(CONTENT_NAME8, props.__scopeHoverCard);
    return (0, import_jsx_runtime20.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime20.jsx)(
...
var HoverCardContentImpl = React25.forwardRef((props, forwardedRef) => {
  const {
    __scopeHoverCard,
    onEscapeKeyDown,
    onPointerDownOutside,
  ...
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [containSelection, setContainSelection] = React25.useState(false);
  React25.useEffect(() => {
    if (containSelection) {
...
var HoverCardArrow = React25.forwardRef(
  (props, forwardedRef) => {
    const { __scopeHoverCard, ...arrowProps } = props;
    const popperScope = usePopperScope2(__scopeHoverCard);
    return (0, import_jsx_runtime20.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var Menubar = React26.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenubar,
      value: valueProp,
    ...
    const [currentTabStopId, setCurrentTabStopId] = React26.useState(null);
    return (0, import_jsx_runtime21.jsx)(
      MenubarContextProvider,
      {
        scope: __scopeMenubar,
        value,
        onMenuOpen: React26.useCallback(
          (value2) => {
            setValue(value2);
        ...
        onMenuClose: React26.useCallback(() => setValue(""), [setValue]),
        onMenuToggle: React26.useCallback(
          (value2) => {
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime21.jsx)(Collection4.Provider, { scope: __scopeMenubar, children: (0, import_jsx_runtime21.jsx)(Collection4.Slot, { scope: __scopeMenubar, children: (0, import_jsx_runtime21.jsx)(
          Root9,
          {
            asChild: true,
            ...rovingFocusGroupScope,
            ...
            children: (0, import_jsx_runtime21.jsx)(Primitive.div, { role: "menubar", ...menubarProps, ref: forwardedRef })
          }
        ) }) })
      }
    );
...
var MenubarMenu = (props) => {
  ...
  const wasKeyboardTriggerOpenRef = React26.useRef(false);
...
var MenubarTrigger = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime21.jsx)(Collection4.ItemSlot, { scope: __scopeMenubar, value: menuContext.value, disabled, children: (0, import_jsx_runtime21.jsx)(
      Item2,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        children: (0, import_jsx_runtime21.jsx)(Anchor2, { asChild: true, ...menuScope, children: (0, import_jsx_runtime21.jsx)(
          Primitive.button,
          {
            type: "button",
            role: "menuitem",
...
var MenubarPortal = (props) => {
  ...
  const menuScope = useMenuScope3(__scopeMenubar);
  return (0, import_jsx_runtime21.jsx)(Portal3, { ...menuScope, ...portalProps });
};
MenubarPortal.displayName = PORTAL_NAME6;
var CONTENT_NAME9 = "MenubarContent";
var MenubarContent = React26.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, align = "start", ...contentProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    const context = useMenubarContext(CONTENT_NAME9, __scopeMenubar);
    const menuContext = useMenubarMenuContext(CONTENT_NAME9, __scopeMenubar);
...
MenubarContent.displayName = CONTENT_NAME9;
var GROUP_NAME5 = "MenubarGroup";
var MenubarGroup = React26.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...groupProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime21.jsx)(Group, { ...menuScope, ...groupProps, ref: forwardedRef });
  }
);
MenubarGroup.displayName = GROUP_NAME5;
var LABEL_NAME5 = "MenubarLabel";
var MenubarLabel = React26.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...labelProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime21.jsx)(Label, { ...menuScope, ...labelProps, ref: forwardedRef });
  }
);
MenubarLabel.displayName = LABEL_NAME5;
var ITEM_NAME6 = "MenubarItem";
var MenubarItem = React26.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...itemProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime21.jsx)(Item22, { ...menuScope, ...itemProps, ref: forwardedRef });
  }
);
MenubarItem.displayName = ITEM_NAME6;
var CHECKBOX_ITEM_NAME4 = "MenubarCheckboxItem";
var MenubarCheckboxItem = React26.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...checkboxItemProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime21.jsx)(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
  }
);
MenubarCheckboxItem.displayName = CHECKBOX_ITEM_NAME4;
var RADIO_GROUP_NAME4 = "MenubarRadioGroup";
var MenubarRadioGroup = React26.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...radioGroupProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime21.jsx)(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
  }
);
MenubarRadioGroup.displayName = RADIO_GROUP_NAME4;
var RADIO_ITEM_NAME4 = "MenubarRadioItem";
var MenubarRadioItem = React26.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...radioItemProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime21.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
  }
);
MenubarRadioItem.displayName = RADIO_ITEM_NAME4;
var INDICATOR_NAME4 = "MenubarItemIndicator";
var MenubarItemIndicator = React26.forwardRef((props, forwardedRef) => {
  const { __scopeMenubar, ...itemIndicatorProps } = props;
  const menuScope = useMenuScope3(__scopeMenubar);
  return (0, import_jsx_runtime21.jsx)(ItemIndicator, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
});
MenubarItemIndicator.displayName = INDICATOR_NAME4;
var SEPARATOR_NAME4 = "MenubarSeparator";
var MenubarSeparator = React26.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...separatorProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime21.jsx)(Separator, { ...menuScope, ...separatorProps, ref: forwardedRef });
  }
);
MenubarSeparator.displayName = SEPARATOR_NAME4;
var ARROW_NAME6 = "MenubarArrow";
var MenubarArrow = React26.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...arrowProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime21.jsx)(Arrow22, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var MenubarSub = (props) => {
  ...
  return (0, import_jsx_runtime21.jsx)(Sub, { ...menuScope, open, onOpenChange: setOpen, children });
};
MenubarSub.displayName = SUB_NAME3;
var SUB_TRIGGER_NAME4 = "MenubarSubTrigger";
var MenubarSubTrigger = React26.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubContent = React26.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenu = React27.forwardRef(
  (props, forwardedRef) => {
    const {
    ...
    const [navigationMenu, setNavigationMenu] = React27.useState(null);
    const composedRef = useComposedRefs(forwardedRef, (node) => setNavigationMenu(node));
    const direction = useDirection(dir);
    const openTimerRef = React27.useRef(0);
    const closeTimerRef = React27.useRef(0);
    const skipDelayTimerRef = React27.useRef(0);
    const [isOpenDelayed, setIsOpenDelayed] = React27.useState(true);
    const [value, setValue] = useControllableState({
      prop: valueProp,
      onChange: (value2) => {
        const isOpen = value2 !== "";
    ...
    const startCloseTimer = React27.useCallback(() => {
      window.clearTimeout(closeTimerRef.current);
      closeTimerRef.current = window.setTimeout(() => setValue(""), 150);
    }, [setValue]);
    const handleOpen = React27.useCallback(
      (itemValue) => {
        window.clearTimeout(closeTimerRef.current);
        setValue(itemValue);
      },
    ...
    const handleDelayedOpen = React27.useCallback(
      (itemValue) => {
...
var NavigationMenuSub = React27.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeNavigationMenu,
      value: valueProp,
    ...
    return (0, import_jsx_runtime22.jsx)(
      NavigationMenuProvider,
      {
        ...
        onItemDismiss: () => setValue(""),
        children: (0, import_jsx_runtime22.jsx)(Primitive.div, { "data-orientation": orientation, ...subProps, ref: forwardedRef })
      }
    );
  }
);
...
var NavigationMenuProvider = (props) => {
  ...
  const [viewportContent, setViewportContent] = React27.useState(/* @__PURE__ */ new Map());
  const [indicatorTrack, setIndicatorTrack] = React27.useState(null);
  return (0, import_jsx_runtime22.jsx)(
    NavigationMenuProviderImpl,
    {
      ...
      onViewportContentChange: React27.useCallback((contentValue, contentData) => {
        setViewportContent((prevContent) => {
          prevContent.set(contentValue, contentData);
          return new Map(prevContent);
        });
      }, []),
      onViewportContentRemove: React27.useCallback((contentValue) => {
        setViewportContent((prevContent) => {
      ...
      children: (0, import_jsx_runtime22.jsx)(Collection5.Provider, { scope, children: (0, import_jsx_runtime22.jsx)(ViewportContentProvider, { scope, items: viewportContent, children }) })
    }
  );
};
var LIST_NAME = "NavigationMenuList";
var NavigationMenuList = React27.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...listProps } = props;
    const context = useNavigationMenuContext(LIST_NAME, __scopeNavigationMenu);
    const list = (0, import_jsx_runtime22.jsx)(Primitive.ul, { "data-orientation": context.orientation, ...listProps, ref: forwardedRef });
    return (0, import_jsx_runtime22.jsx)(Primitive.div, { style: { position: "relative" }, ref: context.onIndicatorTrackChange, children: (0, import_jsx_runtime22.jsx)(Collection5.Slot, { scope: __scopeNavigationMenu, children: context.isRootMenu ? (0, import_jsx_runtime22.jsx)(FocusGroup, { asChild: true, children: list }) : list }) });
  }
);
...
var NavigationMenuItem = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    const focusProxyRef = React27.useRef(null);
    const restoreContentTabOrderRef = React27.useRef(() => {
    });
    const wasEscapeCloseRef = React27.useRef(false);
    const handleContentEntry = React27.useCallback((side = "start") => {
    ...
    const handleContentExit = React27.useCallback(() => {
      if (contentRef.current) {
        const candidates = getTabbableCandidates(contentRef.current);
    ...
    return (0, import_jsx_runtime22.jsx)(
      NavigationMenuItemContextProvider,
      {
        ...
        children: (0, import_jsx_runtime22.jsx)(Primitive.li, { ...itemProps, ref: forwardedRef })
      }
    );
  }
);
...
var NavigationMenuTrigger = React27.forwardRef((props, forwardedRef) => {
  ...
  const hasPointerMoveOpenedRef = React27.useRef(false);
  const wasClickCloseRef = React27.useRef(false);
  const open = itemContext.value === context.value;
  return (0, import_jsx_runtime22.jsxs)(import_jsx_runtime22.Fragment, { children: [
    (0, import_jsx_runtime22.jsx)(Collection5.ItemSlot, { scope: __scopeNavigationMenu, value: itemContext.value, children: (0, import_jsx_runtime22.jsx)(FocusGroupItem, { asChild: true, children: (0, import_jsx_runtime22.jsx)(
      Primitive.button,
      {
        id: triggerId,
        disabled,
    ...
    open && (0, import_jsx_runtime22.jsxs)(import_jsx_runtime22.Fragment, { children: [
      ...
      context.viewport && (0, import_jsx_runtime22.jsx)("span", { "aria-owns": contentId })
    ] })
  ] });
});
...
var NavigationMenuLink = React27.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, active, onSelect, ...linkProps } = props;
    return (0, import_jsx_runtime22.jsx)(FocusGroupItem, { asChild: true, children: (0, import_jsx_runtime22.jsx)(
      Primitive.a,
      {
...
var NavigationMenuIndicator = React27.forwardRef((props, forwardedRef) => {
  ...
  return context.indicatorTrack ? ReactDOM2.createPortal(
    (0, import_jsx_runtime22.jsx)(Presence, { present: forceMount || isVisible, children: (0, import_jsx_runtime22.jsx)(NavigationMenuIndicatorImpl, { ...indicatorProps, ref: forwardedRef }) }),
    context.indicatorTrack
  ) : null;
});
NavigationMenuIndicator.displayName = INDICATOR_NAME5;
var NavigationMenuIndicatorImpl = React27.forwardRef((props, forwardedRef) => {
  ...
  const [activeTrigger, setActiveTrigger] = React27.useState(
    null
  );
  const [position, setPosition] = React27.useState(null);
  ...
  return position ? (0, import_jsx_runtime22.jsx)(
    Primitive.div,
    {
      "aria-hidden": true,
...
var CONTENT_NAME10 = "NavigationMenuContent";
var NavigationMenuContent = React27.forwardRef((props, forwardedRef) => {
  const { forceMount, ...contentProps } = props;
  const context = useNavigationMenuContext(CONTENT_NAME10, props.__scopeNavigationMenu);
  const itemContext = useNavigationMenuItemContext(CONTENT_NAME10, props.__scopeNavigationMenu);
  ...
  return !context.viewport ? (0, import_jsx_runtime22.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime22.jsx)(
  ...
  ) }) : (0, import_jsx_runtime22.jsx)(ViewportContentMounter, { forceMount, ...commonProps, ref: composedRefs });
});
NavigationMenuContent.displayName = CONTENT_NAME10;
var ViewportContentMounter = React27.forwardRef((props, forwardedRef) => {
  const context = useNavigationMenuContext(CONTENT_NAME10, props.__scopeNavigationMenu);
...
var NavigationMenuContentImpl = React27.forwardRef((props, forwardedRef) => {
  const {
    __scopeNavigationMenu,
    value,
    triggerRef,
  ...
  const context = useNavigationMenuContext(CONTENT_NAME10, __scopeNavigationMenu);
  const ref = React27.useRef(null);
  const composedRefs = useComposedRefs(ref, forwardedRef);
  const triggerId = makeTriggerId(context.baseId, value);
  const contentId = makeContentId(context.baseId, value);
  const getItems = useCollection5(__scopeNavigationMenu);
  const prevMotionAttributeRef = React27.useRef(null);
  ...
  const motionAttribute = React27.useMemo(() => {
    const items = getItems();
  ...
  return (0, import_jsx_runtime22.jsx)(FocusGroup, { asChild: true, children: (0, import_jsx_runtime22.jsx)(
    DismissableLayer,
    {
      id: contentId,
...
var NavigationMenuViewport = React27.forwardRef((props, forwardedRef) => {
  const { forceMount, ...viewportProps } = props;
  const context = useNavigationMenuContext(VIEWPORT_NAME, props.__scopeNavigationMenu);
  const open = Boolean(context.value);
  return (0, import_jsx_runtime22.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime22.jsx)(NavigationMenuViewportImpl, { ...viewportProps, ref: forwardedRef }) });
});
NavigationMenuViewport.displayName = VIEWPORT_NAME;
var NavigationMenuViewportImpl = React27.forwardRef((props, forwardedRef) => {
  ...
  const [size4, setSize] = React27.useState(null);
  ...
  return (0, import_jsx_runtime22.jsx)(
    Primitive.div,
    {
      ...
      children: Array.from(viewportContentContext.items).map(([value, { ref, forceMount, ...props2 }]) => {
        ...
        return (0, import_jsx_runtime22.jsx)(Presence, { present: forceMount || isActive, children: (0, import_jsx_runtime22.jsx)(
          NavigationMenuContentImpl,
          {
            ...props2,
...
var FocusGroup = React27.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...groupProps } = props;
    const context = useNavigationMenuContext(FOCUS_GROUP_NAME, __scopeNavigationMenu);
    return (0, import_jsx_runtime22.jsx)(FocusGroupCollection.Provider, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime22.jsx)(FocusGroupCollection.Slot, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime22.jsx)(Primitive.div, { dir: context.dir, ...groupProps, ref: forwardedRef }) }) });
  }
);
var ARROW_KEYS = ["ArrowRight", "ArrowLeft", "ArrowUp", "ArrowDown"];
var FOCUS_GROUP_ITEM_NAME = "FocusGroupItem";
var FocusGroupItem = React27.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...groupProps } = props;
    const getItems = useFocusGroupCollection(__scopeNavigationMenu);
    const context = useNavigationMenuContext(FOCUS_GROUP_ITEM_NAME, __scopeNavigationMenu);
    return (0, import_jsx_runtime22.jsx)(FocusGroupCollection.ItemSlot, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime22.jsx)(
      Primitive.button,
      {
        ...groupProps,
        ref: forwardedRef,
...
var OneTimePasswordField = React28.forwardRef(
  function OneTimePasswordFieldImpl({
    ...
    const sanitizeValue = React28.useCallback(
      (value2) => {
    ...
    const controlledValue = React28.useMemo(() => {
    ...
    const [value, setValue] = useControllableState({
      ...
      onChange: React28.useCallback(
        (value2) => onValueChange == null ? void 0 : onValueChange(value2.join("")),
        [onValueChange]
      )
    });
    const latestValueRef = React28.useRef(value);
    latestValueRef.current = value;
    const dispatch = React28.useCallback(
      (action) => {
        var _a3, _b, _c, _d, _e, _f, _g, _h, _i;
        const value2 = latestValueRef.current;
        switch (action.type) {
          case "SET_CHAR": {
            const { index: index2, char } = action;
            const currentTarget = (_a3 = collection.at(index2)) == null ? void 0 : _a3.element;
            if (value2[index2] === char) {
            ...
            if (value2.length >= collection.size) {
          ...
          case "CLEAR_CHAR": {
            ...
            const newValue = value2.filter((_, i) => i !== index2);
          ...
          case "PASTE": {
            ...
            const value3 = sanitizedValue.slice(0, collection.size);
            (0, import_react_dom2.flushSync)(() => setValue(value3));
            focusInput((_i = collection.at(value3.length - 1)) == null ? void 0 : _i.element);
            return;
          }
        }
      },
    ...
    const validationTypeRef = React28.useRef(validation);
    React28.useEffect(() => {
      var _a3;
      if (!validation) {
        return;
    ...
    const hiddenInputRef = React28.useRef(null);
    const userActionRef = React28.useRef(null);
    ...
    const locateForm = React28.useCallback(() => {
      var _a3;
      let formElement;
      if (form) {
    ...
    const attemptSubmit = React28.useCallback(() => {
    ...
    const valueRef = React28.useRef(currentValue);
    ...
    return (0, import_jsx_runtime23.jsx)(
      OneTimePasswordFieldContext,
      {
        ...
        isHydrated,
        sanitizeValue,
        children: (0, import_jsx_runtime23.jsx)(Collection6.Provider, { scope: __scopeOneTimePasswordField, state: collectionState, children: (0, import_jsx_runtime23.jsx)(Collection6.Slot, { scope: __scopeOneTimePasswordField, children: (0, import_jsx_runtime23.jsx)(
          Root9,
          {
            asChild: true,
            ...rovingFocusGroupScope,
...
var OneTimePasswordFieldHiddenInput = React28.forwardRef(function OneTimePasswordFieldHiddenInput2({ __scopeOneTimePasswordField, ...props }, forwardedRef) {
...
var OneTimePasswordFieldInput = React28.forwardRef(function OneTimePasswordFieldInput2({
  __scopeOneTimePasswordField,
  onInvalidChange,
  index: indexProp,
  ...props
  ...
  const [element, setElement] = React28.useState(null);
  ...
  const keyboardActionTimeoutRef = React28.useRef(null);
  React28.useEffect(() => {
    return () => {
  ...
  return (0, import_jsx_runtime23.jsx)(Collection6.ItemSlot, { scope: __scopeOneTimePasswordField, children: (0, import_jsx_runtime23.jsx)(
    Item2,
    {
      ...rovingFocusGroupScope,
      asChild: true,
...
var PasswordToggleField = ({
  ...
  const [inputIdState, setInputIdState] = React29.useState(defaultInputId);
  const inputId = inputIdState ?? defaultInputId;
  const syncInputId = React29.useCallback(
  ...
  const focusState = React29.useRef(INITIAL_FOCUS_STATE);
...
var PasswordToggleFieldInput = React29.forwardRef(
  ({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React29.forwardRef(
  ({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    ...
    const [internalAriaLabel, setInternalAriaLabel] = React29.useState(void 0);
    const elementRef = React29.useRef(null);
...
var PasswordToggleFieldIcon = React29.forwardRef(
  ({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
    ...
    return (0, import_jsx_runtime24.jsx)(Primitive.svg, { ...domProps, ref: forwardedRef, "aria-hidden": true, asChild: true, children: visible ? visibleIcon : hiddenIcon });
  }
);
...
var Popover = (props) => {
  ...
  return (0, import_jsx_runtime25.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime25.jsx)(
    PopoverProvider,
    {
...
var PopoverAnchor = React30.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime25.jsx)(Anchor, { ...popperScope, ...anchorProps, ref: forwardedRef });
  }
);
...
var PopoverTrigger = React30.forwardRef(
  (props, forwardedRef) => {
    ...
    const trigger = (0, import_jsx_runtime25.jsx)(
      Primitive.button,
      {
        type: "button",
    ...
    return context.hasCustomAnchor ? trigger : (0, import_jsx_runtime25.jsx)(Anchor, { asChild: true, ...popperScope, children: trigger });
  }
);
...
var PopoverPortal = (props) => {
  ...
  return (0, import_jsx_runtime25.jsx)(PortalProvider3, { scope: __scopePopover, forceMount, children: (0, import_jsx_runtime25.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime25.jsx)(Portal, { asChild: true, container, children }) }) });
};
PopoverPortal.displayName = PORTAL_NAME7;
var CONTENT_NAME11 = "PopoverContent";
var PopoverContent = React30.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext3(CONTENT_NAME11, props.__scopePopover);
    const { forceMount = portalContext.forceMount, ...contentProps } = props;
    const context = usePopoverContext(CONTENT_NAME11, props.__scopePopover);
    return (0, import_jsx_runtime25.jsx)(Presence, { present: forceMount || context.open, children: context.modal ? (0, import_jsx_runtime25.jsx)(PopoverContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime25.jsx)(PopoverContentNonModal, { ...contentProps, ref: forwardedRef }) });
  }
);
PopoverContent.displayName = CONTENT_NAME11;
...
var PopoverContentModal = React30.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime25.jsx)(Combination_default, { as: Slot2, allowPinchZoom: true, children: (0, import_jsx_runtime25.jsx)(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
...
var PopoverContentImpl = React30.forwardRef(
  (props, forwardedRef) => {
    ...
    const context = usePopoverContext(CONTENT_NAME11, __scopePopover);
    const popperScope = usePopperScope3(__scopePopover);
    useFocusGuards();
    return (0, import_jsx_runtime25.jsx)(
      FocusScope,
...
var PopoverArrow = React30.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopperScope3(__scopePopover);
    return (0, import_jsx_runtime25.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var Progress = React31.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeProgress,
    ...
    return (0, import_jsx_runtime26.jsx)(ProgressProvider, { scope: __scopeProgress, value, max: max2, children: (0, import_jsx_runtime26.jsx)(
      Primitive.div,
      {
        "aria-valuemax": max2,
        "aria-valuemin": 0,
...
var ProgressIndicator = React31.forwardRef(
  (props, forwardedRef) => {
...
function RadioProvider(props) {
  ...
  const [control, setControl] = React32.useState(null);
  const [bubbleInput, setBubbleInput] = React32.useState(null);
  ...
  return (0, import_jsx_runtime27.jsx)(RadioProviderImpl, { scope: __scopeRadio, ...context, children: isFunction2(internal_do_not_use_render) ? internal_do_not_use_render(context) : children });
}
var TRIGGER_NAME11 = "RadioTrigger";
var RadioTrigger = React32.forwardRef(
  ({ __scopeRadio, onClick, ...radioProps }, forwardedRef) => {
    const {
      ...
      isFormControl: isFormControl2,
      bubbleInput
    } = useRadioContext(TRIGGER_NAME11, __scopeRadio);
    const composedRefs = useComposedRefs(forwardedRef, setControl);
...
RadioTrigger.displayName = TRIGGER_NAME11;
...
var RadioIndicator = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime27.jsx)(Presence, { present: forceMount || context.checked, children: (0, import_jsx_runtime27.jsx)(
      Primitive.span,
      {
...
var RadioBubbleInput = React32.forwardRef(
  ({ __scopeRadio, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = React32.useRef(checked);
    return (0, import_jsx_runtime27.jsx)(
      Primitive.input,
      {
        type: "radio",
...
var RadioGroupItemTrigger = React210.forwardRef((props, forwardedRef) => {
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime28.jsx)(
      RadioGroupItemProvider,
      {
        ...
        value,
        disabled,
        internal_do_not_use_render: ({ isFormControl: isFormControl2 }) => (0, import_jsx_runtime28.jsxs)(import_jsx_runtime28.Fragment, { children: [
          ...
          isFormControl2 && (0, import_jsx_runtime28.jsx)(
...
var RadioGroupItemBubbleInput = React210.forwardRef((props, forwardedRef) => {
  const { __scopeRadioGroup, ...bubbleProps } = props;
  const radioScope = useRadioScope(__scopeRadioGroup);
  return (0, import_jsx_runtime28.jsx)(RadioBubbleInput, { ...radioScope, ...bubbleProps, ref: forwardedRef });
});
...
var RadioGroupIndicator = React210.forwardRef(
  (props, forwardedRef) => {
    ...
    const radioScope = useRadioScope(__scopeRadioGroup);
    return (0, import_jsx_runtime28.jsx)(RadioIndicator, { ...radioScope, ...indicatorProps, ref: forwardedRef });
  }
);
    ...
    return (0, import_jsx_runtime29.jsxs)(import_jsx_runtime29.Fragment, { children: [
      ...
      (0, import_jsx_runtime29.jsx)(
        Primitive.div,
        {
          ...
          children: (0, import_jsx_runtime29.jsx)("div", { ref: context.onContentChange, style: { minWidth: "100%", display: "table" }, children })
        }
      )
    ] });
  }
...
var ScrollAreaScrollbar = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.type === "hover" ? (0, import_jsx_runtime29.jsx)(ScrollAreaScrollbarHover, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "scroll" ? (0, import_jsx_runtime29.jsx)(ScrollAreaScrollbarScroll, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "auto" ? (0, import_jsx_runtime29.jsx)(ScrollAreaScrollbarAuto, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "always" ? (0, import_jsx_runtime29.jsx)(ScrollAreaScrollbarVisible, { ...scrollbarProps, ref: forwardedRef, "data-state": "visible" }) : null;
  }
);
...
var ScrollAreaScrollbarHover = React211.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime29.jsx)(Presence, { present: forceMount || visible, children: (0, import_jsx_runtime29.jsx)(
...
var ScrollAreaScrollbarScroll = React211.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime29.jsx)(Presence, { present: forceMount || state !== "hidden", children: (0, import_jsx_runtime29.jsx)(
...
var ScrollAreaThumb = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime29.jsx)(Presence, { present: forceMount || scrollbarContext.hasThumb, children: (0, import_jsx_runtime29.jsx)(ScrollAreaThumbImpl, { ref: forwardedRef, ...thumbProps }) });
  }
);
...
var ScrollAreaCorner = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return hasCorner ? (0, import_jsx_runtime29.jsx)(ScrollAreaCornerImpl, { ...props, ref: forwardedRef }) : null;
  }
);
...
var ScrollAreaCornerImpl = React211.forwardRef((props, forwardedRef) => {
  ...
  return hasSize ? (0, import_jsx_runtime29.jsx)(
    Primitive.div,
    {
      ...cornerProps,
      ref: forwardedRef,
...
function SelectProvider(props) {
  ...
  return (0, import_jsx_runtime30.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime30.jsx)(SelectProviderImpl, { scope: __scopeSelect, ...context, children: (0, import_jsx_runtime30.jsx)(Collection7.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime30.jsx)(
...
var Select = (props) => {
  ...
  return (0, import_jsx_runtime30.jsx)(
    SelectProvider,
    {
      __scopeSelect,
      ...providerProps,
      internal_do_not_use_render: ({ isFormControl: isFormControl2 }) => (0, import_jsx_runtime30.jsxs)(import_jsx_runtime30.Fragment, { children: [
        children,
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime30.jsx)(
      Primitive.span,
      {
        ...
        children: (0, import_jsx_runtime30.jsx)(React34.Fragment, { children: showPlaceholder ? placeholder : children }, showPlaceholder ? "placeholder" : "value")
      }
    );
  }
);
...
var [PortalProvider4, usePortalContext4] = createSelectContext(PORTAL_NAME8, {
  forceMount: void 0
});
var SelectPortal = (props) => {
  const { __scopeSelect, forceMount, ...portalProps } = props;
  return (0, import_jsx_runtime30.jsx)(PortalProvider4, { scope: props.__scopeSelect, forceMount, children: (0, import_jsx_runtime30.jsx)(Portal, { asChild: true, ...portalProps }) });
};
SelectPortal.displayName = PORTAL_NAME8;
var CONTENT_NAME12 = "SelectContent";
var SelectContent = React34.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext4(CONTENT_NAME12, props.__scopeSelect);
    const { forceMount = portalContext.forceMount, ...contentProps } = props;
    const context = useSelectContext(CONTENT_NAME12, props.__scopeSelect);
    const [fragment, setFragment] = React34.useState();
    useLayoutEffect2(() => {
      setFragment(new DocumentFragment());
    }, []);
    return (0, import_jsx_runtime30.jsx)(Presence, { present: forceMount || context.open, children: ({ present }) => present ? (0, import_jsx_runtime30.jsx)(SelectContentImpl, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime30.jsx)(SelectContentFragment, { ...contentProps, fragment }) });
  }
);
SelectContent.displayName = CONTENT_NAME12;
var SelectContentFragment = React34.forwardRef((props, forwardedRef) => {
  ...
  return ReactDOM3.createPortal(
    (0, import_jsx_runtime30.jsx)(SelectContentProvider, { scope: __scopeSelect, children: (0, import_jsx_runtime30.jsx)(Collection7.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime30.jsx)("div", { ref: forwardedRef, children }) }) }),
    fragment
  );
});
SelectContentFragment.displayName = "SelectContentFragment";
var CONTENT_MARGIN = 10;
var [SelectContentProvider, useSelectContentContext] = createSelectContext(CONTENT_NAME12);
...
var SelectContentImpl = React34.forwardRef(
  (props, forwardedRef) => {
    ...
    const context = useSelectContext(CONTENT_NAME12, __scopeSelect);
    ...
    useFocusGuards();
    const focusFirst5 = React34.useCallback(
      (candidates) => {
    ...
    const handleItemLeave = React34.useCallback(() => content == null ? void 0 : content.focus(), [content]);
    ...
    return (0, import_jsx_runtime30.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime30.jsx)(Combination_default, { as: Slot3, allowPinchZoom: true, children: (0, import_jsx_runtime30.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectItemAlignedPosition = React34.forwardRef((props, forwardedRef) => {
  ...
  const context = useSelectContext(CONTENT_NAME12, __scopeSelect);
  const contentContext = useSelectContentContext(CONTENT_NAME12, __scopeSelect);
...
var [SelectViewportProvider, useSelectViewportContext] = createSelectContext(CONTENT_NAME12, {});
...
var SelectViewport = React34.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime30.jsxs)(import_jsx_runtime30.Fragment, { children: [
      ...
      (0, import_jsx_runtime30.jsx)(Collection7.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime30.jsx)(
        Primitive.div,
        {
...
var SelectArrow = React34.forwardRef(
  (props, forwardedRef) => {
    ...
    return contentContext.position === "popper" ? (0, import_jsx_runtime30.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
  ...
  ({ __scopeSelect, ...props }, forwardedRef) => {
    ...
    return (0, import_jsx_runtime30.jsxs)(
      Primitive.select,
      {
        ...
        children: [
          shouldShowPlaceholder(value) ? (0, import_jsx_runtime30.jsx)("option", { value: "" }) : null,
...
var Separator3 = React35.forwardRef((props, forwardedRef) => {
...
var Slider = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    const thumbRefs = React36.useRef(/* @__PURE__ */ new Set());
    const valueIndexToChangeRef = React36.useRef(0);
    const isKeyboardInteractionRef = React36.useRef(false);
    ...
    const valuesBeforeSlideStartRef = React36.useRef(values);
    ...
    return (0, import_jsx_runtime32.jsx)(
      SliderProvider,
      {
        ...
        orientation,
        form,
        children: (0, import_jsx_runtime32.jsx)(Collection8.Provider, { scope: props.__scopeSlider, children: (0, import_jsx_runtime32.jsx)(Collection8.Slot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime32.jsx)(
          SliderOrientation,
          {
...
var SliderHorizontal = React36.forwardRef(
  (props, forwardedRef) => {
    const {
      min: min2,
      max: max2,
    ...
    const [slider, setSlider] = React36.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setSlider(node));
    const rectRef = React36.useRef(void 0);
    const direction = useDirection(dir);
    const isDirectionLTR = direction === "ltr";
...
var SliderVertical = React36.forwardRef(
  (props, forwardedRef) => {
    const {
      min: min2,
      max: max2,
...
var SliderImpl = React36.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSlider,
      onSlideStart,
...
var SliderTrack = React36.forwardRef(
  (props, forwardedRef) => {
...
var SliderRange = React36.forwardRef(
  (props, forwardedRef) => {
...
function SliderThumbProvider(props) {
  ...
  const getItems = useCollection8(__scopeSlider);
  const [thumb, setThumb] = React36.useState(null);
  const index2 = React36.useMemo(
  ...
  return (0, import_jsx_runtime32.jsx)(SliderThumbContextProvider, { scope: __scopeSlider, ...thumbContext, children: isFunction4(internal_do_not_use_render) ? internal_do_not_use_render(thumbContext) : children });
}
SliderThumbProvider.displayName = THUMB_PROVIDER_NAME;
var THUMB_TRIGGER_NAME = "SliderThumbTrigger";
var SliderThumbTrigger = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime32.jsx)(
      "span",
      {
        ...
        children: (0, import_jsx_runtime32.jsx)(Collection8.ItemSlot, { scope: __scopeSlider, children: (0, import_jsx_runtime32.jsx)(
          Primitive.span,
          {
            role: "slider",
...
var SliderThumb = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime32.jsx)(
      SliderThumbProvider,
      {
        __scopeSlider,
        name,
        internal_do_not_use_render: ({ index: index2, isFormControl: isFormControl2 }) => (0, import_jsx_runtime32.jsxs)(import_jsx_runtime32.Fragment, { children: [
...
var SliderBubbleInput = React36.forwardRef(
...
function SwitchProvider(props) {
  ...
  const [control, setControl] = React37.useState(null);
  const [bubbleInput, setBubbleInput] = React37.useState(null);
  ...
  return (0, import_jsx_runtime33.jsx)(SwitchProviderImpl, { scope: __scopeSwitch, ...context, children: isFunction5(internal_do_not_use_render) ? internal_do_not_use_render(context) : children });
}
var TRIGGER_NAME13 = "SwitchTrigger";
var SwitchTrigger = React37.forwardRef(
  ({ __scopeSwitch, onClick, ...switchProps }, forwardedRef) => {
    const {
      ...
      isFormControl: isFormControl2,
      bubbleInput
    } = useSwitchContext(TRIGGER_NAME13, __scopeSwitch);
    const composedRefs = useComposedRefs(forwardedRef, setControl);
...
SwitchTrigger.displayName = TRIGGER_NAME13;
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime33.jsx)(
      SwitchProvider,
      {
        ...
        form,
        value,
        internal_do_not_use_render: ({ isFormControl: isFormControl2 }) => (0, import_jsx_runtime33.jsxs)(import_jsx_runtime33.Fragment, { children: [
          ...
          isFormControl2 && (0, import_jsx_runtime33.jsx)(
            SwitchBubbleInput,
            {
              __scopeSwitch
            }
...
var SwitchBubbleInput = React37.forwardRef(
  ({ __scopeSwitch, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = React37.useRef(checked);
    return (0, import_jsx_runtime33.jsx)(
      Primitive.input,
      {
        type: "checkbox",
...
var CONTENT_NAME13 = "TabsContent";
var TabsContent = React38.forwardRef(
  (props, forwardedRef) => {
    const { __scopeTabs, value, forceMount, children, ...contentProps } = props;
    const context = useTabsContext(CONTENT_NAME13, __scopeTabs);
    const triggerId = makeTriggerId2(context.baseId, value);
    const contentId = makeContentId2(context.baseId, value);
    const isSelected = value === context.value;
    ...
    return (0, import_jsx_runtime34.jsx)(Presence, { present: forceMount || isSelected, children: ({ present }) => (0, import_jsx_runtime34.jsx)(
      Primitive.div,
      {
        "data-state": isSelected ? "active" : "inactive",
        "data-orientation": context.orientation,
...
TabsContent.displayName = CONTENT_NAME13;
...
var ToastProvider = (props) => {
  ...
  const [toastCount, setToastCount] = React39.useState(0);
  const isFocusedToastEscapeKeyDownRef = React39.useRef(false);
  const isClosePausedRef = React39.useRef(false);
  if (!label.trim()) {
    console.error(
      `Invalid prop \`label\` supplied to \`${PROVIDER_NAME2}\`. Expected non-empty \`string\`.`
    );
  }
  return (0, import_jsx_runtime35.jsx)(Collection9.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime35.jsx)(
    ToastProviderProvider,
    {
      ...
      viewport,
      onViewportChange: setViewport,
      onToastAdd: React39.useCallback(() => setToastCount((prevCount) => prevCount + 1), []),
      onToastRemove: React39.useCallback(() => setToastCount((prevCount) => prevCount - 1), []),
...
var ToastViewport = React39.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
    ...
    return (0, import_jsx_runtime35.jsxs)(
      Branch,
      {
        ...
        children: [
          hasToasts && (0, import_jsx_runtime35.jsx)(
            FocusProxy,
            {
          ...
          (0, import_jsx_runtime35.jsx)(Collection9.Slot, { scope: __scopeToast, children: (0, import_jsx_runtime35.jsx)(Primitive.ol, { tabIndex: -1, ...viewportProps, ref: composedRefs }) }),
          hasToasts && (0, import_jsx_runtime35.jsx)(
            FocusProxy,
            {
...
var Toast = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime35.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime35.jsx)(
      ToastImpl,
      {
        open,
        ...toastProps,
...
var ToastImpl = React39.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
      type = "foreground",
    ...
    return (0, import_jsx_runtime35.jsxs)(import_jsx_runtime35.Fragment, { children: [
      announceTextContent && (0, import_jsx_runtime35.jsx)(
        ToastAnnounce,
        {
          __scopeToast,
          role: "status",
      ...
      (0, import_jsx_runtime35.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM4.createPortal(
        (0, import_jsx_runtime35.jsx)(Collection9.ItemSlot, { scope: __scopeToast, children: (0, import_jsx_runtime35.jsx)(
          Root2,
          {
            asChild: true,
...
var ToastAnnounce = (props) => {
  ...
  return isAnnounced ? null : (0, import_jsx_runtime35.jsx)(Portal, { asChild: true, container: context.announcerContainer || void 0, children: (0, import_jsx_runtime35.jsx)(VisuallyHidden, { ...announceProps, children: renderAnnounceText && (0, import_jsx_runtime35.jsxs)(import_jsx_runtime35.Fragment, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
var ToastTitle = React39.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...titleProps } = props;
    return (0, import_jsx_runtime35.jsx)(Primitive.div, { ...titleProps, ref: forwardedRef });
  }
);
ToastTitle.displayName = TITLE_NAME2;
var DESCRIPTION_NAME2 = "ToastDescription";
var ToastDescription = React39.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...descriptionProps } = props;
    return (0, import_jsx_runtime35.jsx)(Primitive.div, { ...descriptionProps, ref: forwardedRef });
  }
);
ToastDescription.displayName = DESCRIPTION_NAME2;
var ACTION_NAME2 = "ToastAction";
var ToastAction = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime35.jsx)(ToastAnnounceExclude, { altText, asChild: true, children: (0, import_jsx_runtime35.jsx)(ToastClose, { ...actionProps, ref: forwardedRef }) });
  }
);
ToastAction.displayName = ACTION_NAME2;
var CLOSE_NAME2 = "ToastClose";
var ToastClose = React39.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...closeProps } = props;
    const interactiveContext = useToastInteractiveContext(CLOSE_NAME2, __scopeToast);
    return (0, import_jsx_runtime35.jsx)(ToastAnnounceExclude, { asChild: true, children: (0, import_jsx_runtime35.jsx)(
      Primitive.button,
      {
        type: "button",
        ...closeProps,
...
var ToastAnnounceExclude = React39.forwardRef((props, forwardedRef) => {
...
var NAME7 = "Toggle";
var Toggle = React40.forwardRef((props, forwardedRef) => {
...
var ToggleGroup = React41.forwardRef((props, forwardedRef) => {
  const { type, ...toggleGroupProps } = props;
  if (type === "single") {
    const singleProps = toggleGroupProps;
    return (0, import_jsx_runtime37.jsx)(ToggleGroupImplSingle, { ...singleProps, ref: forwardedRef });
  }
  if (type === "multiple") {
    const multipleProps = toggleGroupProps;
    return (0, import_jsx_runtime37.jsx)(ToggleGroupImplMultiple, { ...multipleProps, ref: forwardedRef });
  }
  throw new Error(`Missing prop \`type\` expected on \`${TOGGLE_GROUP_NAME}\``);
});
ToggleGroup.displayName = TOGGLE_GROUP_NAME;
var [ToggleGroupValueProvider, useToggleGroupValueContext] = createToggleGroupContext(TOGGLE_GROUP_NAME);
var ToggleGroupImplSingle = React41.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {
  ...
  return (0, import_jsx_runtime37.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      onItemDeactivate: React41.useCallback(() => setValue(""), [setValue]),
      children: (0, import_jsx_runtime37.jsx)(ToggleGroupImpl, { ...toggleGroupSingleProps, ref: forwardedRef })
    }
  );
});
var ToggleGroupImplMultiple = React41.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {
  ...
  const handleButtonActivate = React41.useCallback(
    (itemValue) => setValue((prevValue = []) => [...prevValue, itemValue]),
    [setValue]
  );
  const handleButtonDeactivate = React41.useCallback(
    (itemValue) => setValue((prevValue = []) => prevValue.filter((value2) => value2 !== itemValue)),
    [setValue]
  );
  return (0, import_jsx_runtime37.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime37.jsx)(ToggleGroupImpl, { ...toggleGroupMultipleProps, ref: forwardedRef })
    }
  );
});
ToggleGroup.displayName = TOGGLE_GROUP_NAME;
var [ToggleGroupContext, useToggleGroupContext] = createToggleGroupContext(TOGGLE_GROUP_NAME);
var ToggleGroupImpl = React41.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToggleGroup,
      disabled = false,
    ...
    return (0, import_jsx_runtime37.jsx)(ToggleGroupContext, { scope: __scopeToggleGroup, rovingFocus, disabled, children: rovingFocus ? (0, import_jsx_runtime37.jsx)(
      Root9,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime37.jsx)(Primitive.div, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime37.jsx)(Primitive.div, { ...commonProps, ref: forwardedRef }) });
  }
);
var ITEM_NAME10 = "ToggleGroupItem";
var ToggleGroupItem = React41.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.rovingFocus ? (0, import_jsx_runtime37.jsx)(
      Item2,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        active: pressed,
        ref,
        children: (0, import_jsx_runtime37.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime37.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef });
  }
);
ToggleGroupItem.displayName = ITEM_NAME10;
var ToggleGroupItemImpl = React41.forwardRef(
  (props, forwardedRef) => {
...
var Toolbar = React42.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, orientation = "horizontal", dir, loop = true, ...toolbarProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    const direction = useDirection(dir);
    return (0, import_jsx_runtime38.jsx)(ToolbarProvider, { scope: __scopeToolbar, orientation, dir: direction, children: (0, import_jsx_runtime38.jsx)(
      Root9,
      {
        asChild: true,
        ...rovingFocusGroupScope,
...
var ToolbarSeparator = React42.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarButton = React42.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...buttonProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    return (0, import_jsx_runtime38.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: !props.disabled, children: (0, import_jsx_runtime38.jsx)(Primitive.button, { type: "button", ...buttonProps, ref: forwardedRef }) });
  }
);
ToolbarButton.displayName = BUTTON_NAME;
var LINK_NAME2 = "ToolbarLink";
var ToolbarLink = React42.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...linkProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    return (0, import_jsx_runtime38.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: true, children: (0, import_jsx_runtime38.jsx)(
      Primitive.a,
      {
        ...linkProps,
        ref: forwardedRef,
...
var ToolbarToggleGroup = React42.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleItem = React42.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...toggleItemProps } = props;
    const toggleGroupScope = useToggleGroupScope(__scopeToolbar);
    const scope = { __scopeToolbar: props.__scopeToolbar };
    return (0, import_jsx_runtime38.jsx)(ToolbarButton, { asChild: true, ...scope, children: (0, import_jsx_runtime38.jsx)(Item25, { ...toggleGroupScope, ...toggleItemProps, ref: forwardedRef }) });
  }
);
...
var PROVIDER_NAME3 = "TooltipProvider";
var DEFAULT_DELAY_DURATION = 700;
var TOOLTIP_OPEN = "tooltip.open";
var [TooltipProviderContextProvider, useTooltipProviderContext] = createTooltipContext(PROVIDER_NAME3);
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React43.useRef(true);
  const isPointerInTransitRef = React43.useRef(false);
  ...
  return (0, import_jsx_runtime39.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React43.useCallback(() => {
        if (skipDelayDuration <= 0) return;
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, [skipDelayDuration]),
      onClose: React43.useCallback(() => {
        if (skipDelayDuration <= 0) return;
        window.clearTimeout(skipDelayTimerRef.current);
        skipDelayTimerRef.current = window.setTimeout(
      ...
      onPointerInTransitChange: React43.useCallback((inTransit) => {
...
TooltipProvider.displayName = PROVIDER_NAME3;
...
var Tooltip = (props) => {
  ...
  const wasOpenDelayedRef = React43.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: (open2) => {
  ...
  const stateAttribute = React43.useMemo(() => {
  ...
  return (0, import_jsx_runtime39.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime39.jsx)(
    TooltipContextProvider,
    {
      ...
      trigger,
      onTriggerChange: setTrigger,
      onTriggerEnter: React43.useCallback(() => {
...
var TRIGGER_NAME15 = "TooltipTrigger";
var TooltipTrigger = React43.forwardRef(
  (props, forwardedRef) => {
    const { __scopeTooltip, ...triggerProps } = props;
    const context = useTooltipContext(TRIGGER_NAME15, __scopeTooltip);
    const providerContext = useTooltipProviderContext(TRIGGER_NAME15, __scopeTooltip);
    const popperScope = usePopperScope5(__scopeTooltip);
    ...
    const handlePointerUp = React43.useCallback(() => isPointerDownRef.current = false, []);
    React43.useEffect(() => {
      return () => document.removeEventListener("pointerup", handlePointerUp);
    }, [handlePointerUp]);
    return (0, import_jsx_runtime39.jsx)(Anchor, { asChild: true, ...popperScope, children: (0, import_jsx_runtime39.jsx)(
      Primitive.button,
      {
...
TooltipTrigger.displayName = TRIGGER_NAME15;
var PORTAL_NAME9 = "TooltipPortal";
var [PortalProvider5, usePortalContext5] = createTooltipContext(PORTAL_NAME9, {
  forceMount: void 0
});
var TooltipPortal = (props) => {
  const { __scopeTooltip, forceMount, children, container } = props;
  const context = useTooltipContext(PORTAL_NAME9, __scopeTooltip);
  return (0, import_jsx_runtime39.jsx)(PortalProvider5, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime39.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime39.jsx)(Portal, { asChild: true, container, children }) }) });
};
TooltipPortal.displayName = PORTAL_NAME9;
var CONTENT_NAME14 = "TooltipContent";
var TooltipContent = React43.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext5(CONTENT_NAME14, props.__scopeTooltip);
    const { forceMount = portalContext.forceMount, side = "top", ...contentProps } = props;
    const context = useTooltipContext(CONTENT_NAME14, props.__scopeTooltip);
    return (0, import_jsx_runtime39.jsx)(Presence, { present: forceMount || context.open, children: context.disableHoverableContent ? (0, import_jsx_runtime39.jsx)(TooltipContentImpl, { side, ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime39.jsx)(TooltipContentHoverable, { side, ...contentProps, ref: forwardedRef }) });
  }
);
var TooltipContentHoverable = React43.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME14, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME14, props.__scopeTooltip);
  const ref = React43.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React43.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React43.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React43.useCallback(
    (event, hoverTarget) => {
  ...
  return (0, import_jsx_runtime39.jsx)(TooltipContentImpl, { ...props, ref: composedRefs });
});
var [VisuallyHiddenContentContextProvider, useVisuallyHiddenContentContext] = createTooltipContext(TOOLTIP_NAME, { isInside: false });
var Slottable2 = createSlottable("TooltipContent");
var TooltipContentImpl = React43.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
    ...
    const context = useTooltipContext(CONTENT_NAME14, __scopeTooltip);
    const popperScope = usePopperScope5(__scopeTooltip);
      ...
      DismissableLayer,
      {
        ...
        children: (0, import_jsx_runtime39.jsxs)(
          Content3,
          {
            ...
            children: [
              (0, import_jsx_runtime39.jsx)(Slottable2, { children }),
              (0, import_jsx_runtime39.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime39.jsx)(Root4, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
TooltipContent.displayName = CONTENT_NAME14;
var ARROW_NAME9 = "TooltipArrow";
var TooltipArrow = React43.forwardRef(
  (props, forwardedRef) => {
    ...
    return visuallyHiddenContentContext.isInside ? null : (0, import_jsx_runtime39.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
